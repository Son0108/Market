    ...
    return (
        <SafeAreaView style={{backgroundColor: '#DDDDDD', height: '100%'}}>
            ...
            <View style={{alignItems:'center', marginTop: 20}}>
                ...
                <TextInput placeholder='Vui lòng nhâp tên sản phẩm' style={{ paddingLeft: 10,height:40,width:'90%',borderWidth:1,borderRadius:6, marginTop: 10, backgroundColor: '#FFFF'}}></TextInput>
                <Text style={styles.text}>Nhập giá tiền của sản phẩm</Text>
                <TextInput placeholder='Nhập giá tiền' style={{ paddingLeft: 10, height:40,width:'90%',borderWidth:1, borderRadius:6, marginTop: 10,backgroundColor: '#FFFF'}}></TextInput>
                <Text style={styles.text}>Mô tả sản phẩm</Text>
                <TextInput placeholder='Nhập mô tả' style={{paddingLeft: 10, height:60, width:'90%',borderWidth:1, borderRadius:6, marginTop: 10, marginBottom: 20,backgroundColor: '#FFFF'}}></TextInput>
            </View>

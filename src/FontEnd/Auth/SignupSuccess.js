  ...
  render() {
    ...
    return (
      <SafeAreaView style={{flex:1,justifyContent:'center',alignItems: 'center'}}>
        ...
        <TouchableOpacity onPress={() => {navigation.navigate('Login')}} style={{marginTop: 30,marginLeft: 25,backgroundColor: '#DB3022',width: 360, height:48, borderRadius: 25, justifyContent:'center', alignItems: 'center'}}>
